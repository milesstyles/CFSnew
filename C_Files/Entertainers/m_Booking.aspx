<%@Page Language="C#"  AutoEventWireup="true" CodeFile="m_Booking.aspx.cs" Inherits="Booking" %>
...
<form id="Form1" runat="server">
    ...
    <p runat="server" id="pIpMsg" ></p>
       ...
       <!-- <asp:PlaceHolder runat="server" ID="pHldForm" >-->
        ...
        <label>
            <asp:Label runat="server" ID="lbFirstName" Text="First Name:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbFirstName" CssClass="textfield" MaxLength="30" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLastName" Text="Last Name:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLastName" CssClass="textfield" MaxLength="30" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbEmail" Text="Email:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbEmail" CssClass="textfield" MaxLength="50" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbAddress1" Text="Address 1:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbAddress1" CssClass="textfield" MaxLength="50" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbAddress2" Text="Address 2:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbAddress2" CssClass="textfield" MaxLength="50" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbCity" Text="City:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbCity" CssClass="textfield" MaxLength="30" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbState" Text="State:" CssClass="formLabel" /><br />
            <asp:DropDownList runat="server" ID="ddlState" CssClass="select" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbZip" Text="Zip:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbZip" CssClass="textfield formQuarterWidth" MaxLength="5" />
            <span class="required" >*</span>
        </label>
        <div class="cleaner">&nbsp;</div>
        <label><br />
            <asp:Label runat="server" ID="lbHomePhone" Text="Home Phone:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbHomePhone" CssClass="textfield" MaxLength="20" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbCellPhone" Text="Cell Phone:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbCellPhone" CssClass="textfield" MaxLength="20" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbReferred" Text="Referred By:" CssClass="formLabel" /><br />
        ...
        <label><br />
            <asp:Label runat="server" ID="lbCopyAddress" Text="Copy Address From Above:" CssClass="formLabel" /><br />
            <asp:CheckBox runat="server" ID="chkCopyAddress" AutoPostBack="true"
        oncheckedchanged="chkCopyAddress_CheckedChanged"/>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLocName" Text="Location Name:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLocName" CssClass="textfield" MaxLength="50" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLocationAddress1" Text="Location Address:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLocationAddress1" CssClass="textfield" MaxLength="50" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLocAddress2" Text="Loc Address 2:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLocAddress2" CssClass="textfield" MaxLength="50" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLocCity" Text="Location City:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLocCity" CssClass="textfield" MaxLength="30" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLocState" Text="Location State:" CssClass="formLabel" /><br />
            <asp:DropDownList runat="server" ID="ddlLocState" CssClass="select" />
            <span class="required" >*</span>
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbLocZip" Text="Location Zip:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLocZip" CssClass="textfield formQuarterWidth" MaxLength="5" />
        </label>
        <div class="cleaner">&nbsp;</div>
        <label><br />
            <asp:Label runat="server" ID="lbLocPhone" Text="Location Phone:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbLocPhone" CssClass="textfield" MaxLength="20" />
        </label>
        <label><br />
            <asp:Label runat="server" ID="lbCrossSt" Text="Main Cross Street:" CssClass="formLabel" /><br />
        ...
        <label class="full"><br />
            <asp:Label runat="server" ID="lblNumDancers" Text="Number of Dancers Requested:" CssClass="formLabel" /><br /><br />
            <asp:DropDownList runat="server" ID="ddlNumDancers" CssClass="select formHalfWidth" />
            <br />Please call our office directly for more than 6 entertainers
        </label>
        <label class="full"><br />
            <asp:Label runat="server" ID="lbShowLength" Text="Length of Show:" CssClass="formLabel" /><br />
        ...
        <label class="full"><br />
            <asp:Label runat="server" ID="lbArrivalTime" Text="Requested Entertainment Arrival Time:" CssClass="formLabel" /><br />
            <asp:DropDownList runat="server" ID="ddlArrivalTime" CssClass="select">
            </asp:DropDownList>
        </label>
        <label class="full"><br />
            <asp:Label runat="server" ID="lbCrowdType" Text="Type of Crowd:" CssClass="formLabel" /><br />
        ...
        <label class="full"><br />
            <asp:Label runat="server" ID="lbAgeRange" Text="Age Range Of Guests:" CssClass="formLabel" /><br />
        ...
        <label class="full"><br />
            <asp:Label runat="server" ID="lbGuestHonor" Text="Guest of Honor Name:" CssClass="formLabel" /><br />
            <asp:TextBox runat="server" ID="tbGuestHonor" CssClass="textfield" MaxLength="64" />
        </label>
        <label class="full"><br />
            <asp:Label runat="server" ID="lbSurprise" Text="Is This a Surprise Party?" CssClass="formLabel" /><br />
            <asp:CheckBox runat="server" ID="chkSurprise" />
            Select if yes. 
        </label>
        <label class="full"><br />
            <asp:Label runat="server" ID="lbSpecialInst" Text="Special Instructions:" CssClass="formLabel" /><br />

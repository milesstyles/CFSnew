...
public partial class Booking : System.Web.UI.Page
{
    ...
    protected void chkCopyAddress_CheckedChanged(object sender, EventArgs e)
    {
        if(chkCopyAddress.Checked==true)
        {
            ...
            tbLocationAddress1.Text = tbAddress1.Text;
            tbLocAddress2.Text = tbAddress2.Text;
            tbLocCity.Text = tbCity.Text;
            ddlLocState.SelectedValue = ddlState.SelectedValue;
            tbLocZip.Text = tbZip.Text;
            tbLocPhone.Text = tbCellPhone.Text;

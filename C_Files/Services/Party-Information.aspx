<%@ Language="C#" MasterPageFile="~/Content.master" AutoEventWireup="true" CodeFile="Party-Information.aspx.cs" Inherits="Services_Party_Information" %>

<asp:Content ID="contentHead" ContentPlaceHolderID="head" runat="server" >
<title>Stripper Etiquette | Centerfold Strips party information</title>
<meta name="keywords" content="stripper etiquette, centerfold strips party information" />
<meta name="description" content="Important conduct and policy information about Centerfold Strip services." />
<style type="text/css">
    #frameHolder #flashNav
    {
    	background-image:url(../images/headerPartyInformation.jpg);
...
The management at Centerfold Strips values your business. Please carefully read, be cognizant of, and comply with all of our company policies listed below. These policies are in place to ensure that your event with Centerfold Strips will be epic! Thank you for your anticipated cooperation, and lets have some fun!
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentHolder" Runat="Server">
   <div id="padding">
        <h3><img src="../images/h2ImportantInfo.gif" width="250" height="11" alt="" /><span>IMPORTANT INFORMATION ABOUT YOUR EVENT</span></h3>
        <ul>
        ...
        <h3><img src="../images/h2SettingStage.gif" width="250" height="11" alt="" /><span>SETTING THE STAGE</span></h3>
        <ol>
             ...
             <li>Make sure you have a stereo with a CD player &amp; some cds.</li>
        </ol>
        <h3><img src="../images/h2Tipping.gif" width="173" height="11" alt="" /><span>TIPPING</span></h3>
        <p>Please  remember that the strippers work for tips throughout the entire party.  To maximize the enjoyment of the party, employ the same type of tipping  rules as if you were at a strip club. We recommend that your guests be  informed in advance to bring plenty of small bills and be prepared for  the thrills! The more you tip – the more they strip!</p>
        <h3><img src="../images/h2PartyHosts.gif" width="173" height="11" alt="" /><span>PARTY HOST’S RESPONSIBILITY</span></h3>

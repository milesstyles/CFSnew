<%@ Page Language="C#" Title="Centerfold Strips | Add / Edit Employee" AutoEventWireup="true" MasterPageFile="~/backend/MasterPage.master" CodeFile="add_employee.aspx.cs" Inherits="backend_add_employee" EnableEventValidation="false" %>
            ...
            <h2>Employee Images and Media</h2><asp:UpdatePanel runat="server" ID="uPnlMedia" >
                    <ContentTemplate>
                        <table width="100%" cellspacing="0">
                            ...
                            <tr>
                                <td></td>
                                <td><a class="thickbox" href="edit_images.aspx?id=<%= Request.QueryString["empid"] %>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=800&width=1020&modal=true">Add / Edit Images</a></td></tr><tr>

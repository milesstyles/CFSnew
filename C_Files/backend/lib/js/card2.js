...
Card = (function() {
  ...
  Card.prototype.defaults = {
    formatting: true,
    formSelectors: {
      numberInput: 'input[name="ctl00$mainContent$tBoxCCNum"]',
      expiryInput: 'input[name="ctl00$mainContent$tBoxCCExpire"]',
      cvcInput: 'input[name="ctl00$mainContent$tBoxCCCv2Num"]',
      nameInput: 'input[name="ctl00$mainContent$tBoxCCNameOnCard"]' 
    },
    cardSelectors: {
...
//      nameInput: 'input[name="ctl00$mainContent$tBoxCCNameOnCard"]' 
    ...
    var val = $("#ctl00_mainContent_tBoxCCNum").val();
    var expiryval = $("#ctl00_mainContent_tBoxCCExpire").val();
    var cvcval = $("#ctl00_mainContent_tBoxCCCv2Num").val();
    var nameval = $("#ctl00_mainContent_tBoxCCNameOnCard").val();

    $(".jp-card-number").html(val);
    $(".jp-card-expiry").html(expiryval);
    $(".jp-card-cvc").html(cvcval);
    $(".jp-card-name").html(nameval);
     
    var cardobj = cardFromNumber2(val)

    if (cardobj.type == "visa")
    {
       
        $(".jp-card").addClass("jp-card-visa jp-card-identified")
        $(".jp-card-unknown").removeClass("jp-card-unknown")
    }
    if (cardobj.type == "amex") {

        $(".jp-card").addClass("jp-card-amex jp-card-identified")
        $(".jp-card-unknown").removeClass("jp-card-unknown")
    }
    if (cardobj.type == "mastercard") {

        $(".jp-card").addClass("jp-card-mastercard jp-card-identified")
        $(".jp-card-unknown").removeClass("jp-card-unknown")
    }
